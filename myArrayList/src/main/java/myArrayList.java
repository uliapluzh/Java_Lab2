...
public class myArrayList<T> implements List<T>{
    ...
    private class myListIterator implements ListIterator<T> {
        ...
        public void add(T e) {
            ...
            size++;
            checkSize();
            System.arraycopy(elements, curIndex, elements, curIndex + 1, realSize - curIndex);
            elements[curIndex] = e;
            curIndex++;
        }
    }
    ...
    public Object[] toArray() {
        Object[] elements2 = new Object[size];
        System.arraycopy(elements, 0, elements2, 0, size);
    ...
    public boolean addAll(int index, Collection<? extends T> c) {
        ...
        if (index < realSize) {
            System.arraycopy(elements, index, elements, index + c.size(), realSize - index);
        }
    ...
    public T set(int index, T element) {
        ...
        Object old_elem = elements[index];
    ...
    public void add(int index, T element) {
        ...
        System.arraycopy(elements, index, elements, index + 1, realSize - index);
        elements[index] = element;
